...
\centering
                \begin{tikzpicture}
								...
								\addplot [smooth, red, samples=100 , domain=-25:25 ] {(3.1831/(1 + 100 *(-23 + x)^2) + 3.1831/( 1 + 100 *(-20 + x)^2) + 3.1831/(1 + 100 *(-17 + x)^2) + 3.1831/( 1 + 100 *(-14 + x)^2)+ 3.1831/( 1 + 100 *(-11 + x)^2) + 3.1831/(1 + 100 *(1 + x)^2) + 3.1831/( 1 + 100 *(-8 + x)^2) + 3.1831/(1 + 100 *(-5 + x)^2) + 3.1831/( 1 + 100 *(-2 + x)^2) + 3.1831/( 1 + 100 *(4 + x)^2) + 3.1831/(1 + 100 *(7 + x)^2) + 3.1831/( 1 + 100 *(10 + x)^2) + 3.1831/(1 + 100 *(13 + x)^2) + 3.1831/( 1 + 100* (16 + x)^2) + 3.1831/(1 + 100 *(19 + x)^2) + 3.1831/( 1 + 100 *(22 + x)^2) + 3.1831/(1 + 100 *(25 + x)^2))*e^(-(x^2/200))/(10 *sqrt(2 * 3.1415))};
								
								
								\addplot [smooth, red, very thick, samples=50 , domain=-15:15 ] {(3.1831/(1 + 100 *(-23 + x)^2) + 3.1831/( 1 + 100 *(-20 + x)^2) + 3.1831/(1 + 100 *(-17 + x)^2) + 3.1831/( 1 + 100 *(-14 + x)^2)+ 3.1831/( 1 + 100 *(-11 + x)^2) + 3.1831/(1 + 100 *(1 + x)^2) + 3.1831/( 1 + 100 *(-8 + x)^2) + 3.1831/(1 + 100 *(-5 + x)^2) + 3.1831/( 1 + 100 *(-2 + x)^2) + 3.1831/( 1 + 100 *(4 + x)^2) + 3.1831/(1 + 100 *(7 + x)^2) + 3.1831/( 1 + 100 *(10 + x)^2) + 3.1831/(1 + 100 *(13 + x)^2) + 3.1831/( 1 + 100* (16 + x)^2) + 3.1831/(1 + 100 *(19 + x)^2) + 3.1831/( 1 + 100 *(22 + x)^2) + 3.1831/(1 + 100 *(25 + x)^2))*e^(-(x^2/200))/(10 *sqrt(2 * 3.1415))};
...
\begin{center}
  \begin{tabular}{ | p{2.2cm} | p{2.7cm} | p{2.2cm} | p{2.9cm} | p{5.5cm} | }
    \hline
    % TODO: Fehlerrechnung theoretischer Wert
    Resonator- länge in cm & Modenabstand in µs & Abstand in MHz & Theoretischer Abstand in MHz & Abweichung Gemessener Abstand vom Theoriewert in \% \\ \hline
    25 & 477,43 ± 0,09 & 594,94 ± 0,11 & 600,000 & 0,85 \\ \hline
    32 & 382,12 ± 0,37 & 476,17 ± 0,46 & 468,750 & 1,56 \\ \hline
    39 & 309,39 ± 0,19 & 385,54 ± 0,24 & 384,615 & 0,24 \\ \hline
    46 & 260,89 ± 0,07 & 325,10 ± 0,09 & 326,087 & 0,30 \\ \hline
    53 & 226,22 ± 0,10 & 281,90 ± 0,12 & 283,018 & 0,39 \\ \hline
    60 & 200,68 ± 0,10 & 250,07 ± 0,12 & 250,000 & 0,03 \\ \hline
    67 & 180,45 ± 0,20 & 224,87 ± 0,25 & 223,881 & 0,44 \\ \hline
    74 & 163,46 ± 0,15 & 203,69 ± 0,19 & 202,703 & 0,49 \\ \hline
    81 & 145,15 ± 0,19 & 180,88 ± 0,24 & 185,185 & 2,38 \\ \hline
    88 & 137,48 ± 0,14 & 171,32 ± 0,17 & 170,454 & 0,50 \\ \hline
  \end{tabular}
\end{center}
\FloatBarrier
\begin{center}
...
\begin{thebibliography}{100}
  ...
  \bibitem{TransModeIntensity} \url{http://en.wikipedia.org/w/index.php?title=Transverse_mode&oldid=579051975}
  ...
  \bibitem{Gaussstrahl} \url{http://de.wikipedia.org/w/index.php?title=Gau\%C3\%9F-Strahl&oldid=126980393}
