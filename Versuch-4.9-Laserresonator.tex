...
\begin{center}
    ...
    \hline
    $L$ in cm & $w_x\left(\frac{L}{2}\right)$ in mm & $w_y\left(\frac{L}{2}\right)$ in mm & $w_{lit}$ in mm \\ \hline
    25 & 0,4924 & 0,4798 & 0\\ \hline
    32 & 0,7677 & 0,7491 & 0\\ \hline
    39 & 0,6776 & 0,6703 & 0\\ \hline
    46 & 0,5173 & 0,5728 & 0\\ \hline
    53 & 0,6358 & 0,6383 & 0\\ \hline
    60 & 0,6777 & 0,6899 & 0\\ \hline
    67 & 0,7957 & 0,7758 & 0\\ \hline
    74 & 0,8592 & 0,8857 & 0\\ \hline
    81 & 0,9856 & 1,0212 & 0\\ \hline
    88 & 1,4031 & 1,5161 & 0\\ \hline
    \end{tabular}
\end{center}
...
\addplot[green, densely dashed, mark size=0.0pt, samples=20, domain=20:92]{0.0005*sqrt(1+((x/2)/(4.96459*10^6*0.0005^2))^2)*100};
\end{axis}
\end{tikzpicture}
\captionof{figure}{Strahlbreite als horizontaler und vertikaler Schnitt in Abhängigkeit von der Resonatorlänge.}
\end{figure}
\end{center}
\FloatBarrier
\section{Longitudinale Modensruktur in Abh. von der Resonatorlänge}
